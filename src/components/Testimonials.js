...
const Testimonials = () => (
  ...
  >
    <div className="absolute z-[0] -right bottom-80 w-[50%] h-[50%] rounded-full pink__gradient" />
    <div className="absolute z-[0] w-[60%] h-[60%] -left-1/2 rounded-full blue__gradient bottom-40" />
